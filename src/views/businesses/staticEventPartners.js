export const staticBusiness = [
  {
    ...
    challenge: {
      ...
      content:
        "CHALLENGE: Your challenge is to identify a common, everyday problem or inconvenience and devise a solution for it. You'll need to demonstrate how your solution not only addresses the issue but also introduces a unique and innovative element. INSTRUCTIONS: Choose a common problem: Select a problem that people encounter regularly in their daily lives. It could be related to technology, education, transportation, communication, or any other aspect of daily living. Analyze the problem: Clearly define and analyze the problem. Consider its impact on individuals and society. Identify the root causes and existing solutions (if any). Develop a creative solution: Devise an innovative solution that goes beyond traditional approaches. Your solution should be practical, cost-effective, and feasible for implementation. Explain the rationale: Provide a detailed explanation of why your solution is effective. Use critical thinking to justify your choices and showcase how your solution addresses the core issues. Showcase creativity: Integrate an element of creativity into your solution. This could be a unique feature, design aspect, or approach that sets your solution apart from conventional ideas. Present your solution: Create a presentation or document that clearly communicates your problem statement, solution, rationale, and creative elements. You can use visuals, diagrams, or prototypes to enhance your presentation.", // actual challenge description + instructions
